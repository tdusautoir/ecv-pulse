    ...
    return (<ScrollView style={{ flex: 1 }} className="bg-background">
        <View className="flex flex-col gap-8 items-center">
            <View className="w-full relative rounded-b-3xl overflow-hidden">
                <LinearGradient colors={['#25378D', '#007C82']} end={{ x: 0.75, y: 0.75 }} style={{ width: '100%' }}>
                    <View className="p-6 py-8 flex flex-col gap-8">
                        <View className="flex flex-row justify-between items-center">
                            ...
                            <View className="flex flex-row bg-white/20 py-2 px-4 rounded-full blur-md items-center gap-2">
                                <StarIcon width={16} height={16} color='#86EFAC' />
                        ...
                        <View className="flex flex-col gap-2">
                            ...
                            <Progress indicatorClassName="bg-[#86EFAC]" value={user!.xp} max={1000} className="h-2 bg-white/20" />
                        </View>
                        <View className="bg-white/20 p-8 rounded-2xl flex-col gap-4">
                            <View>
                                <View className="flex flex-row justify-between items-center">
                                    ...
                                    <Button className="bg-[#111827CC] rounded-full"><P className="text-white font-medium">Gérer</P></Button>
                                </View>
