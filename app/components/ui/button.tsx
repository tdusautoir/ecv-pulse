...
function LoadingButton({ ref, className, variant, size, loading, disabled, children, ...props }: ButtonProps & { loading: boolean }) {
...
export { Button, LoadingButton, buttonTextVariants, buttonVariants };
