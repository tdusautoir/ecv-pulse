...
function H1({ className, asChild = false, ...props }: TypographyProps) {
  ...
  return (
    <Component
      ...
      aria-level='1'
      className={cn(
        'web:scroll-m-20 text-4xl text-primary font-extrabold tracking-tight lg:text-5xl web:select-text',
        className
      )}
      {...props}
    />
...
function H2({ className, asChild = false, ...props }: TypographyProps) {
  ...
  return (
    <Component
      ...
      aria-level='2'
      className={cn(
        'web:scroll-m-20 border-b border-border pb-2 text-3xl text-primary font-semibold tracking-tight first:mt-0 web:select-text',
        className
      )}
      {...props}
    />
...
function H3({ className, asChild = false, ...props }: TypographyProps) {
  ...
  return (
    <Component
      ...
      aria-level='3'
      className={cn(
        'web:scroll-m-20 text-2xl text-primary font-semibold tracking-tight web:select-text',
        className
      )}
      {...props}
    />
...
function H4({ className, asChild = false, ...props }: TypographyProps) {
  ...
  return (
    <Component
      ...
      aria-level='4'
      className={cn(
        'web:scroll-m-20 text-xl text-primary font-semibold tracking-tight web:select-text',
        className
      )}
      {...props}
    />
